...
const StarSign = (props: any) => {
    ...
    useEffect(() => {
        let data;
        data = JSON.stringify(profileData?.filter(item => item?.questions_name === 'starSign'));
        ...
        options?.map(item => {
            data[0].options = [
                ...data[0].options,
                {
                    selected: item === userDetails['starSign'] ? true : false,
                    text: item,
                },
            ];
        });
        ...
        <>
            ...
            {listData[count]?.options?.filter(item => item?.selected)?.length >
                ...
                <View
                    ...
                    <GradientBtn
                        onPress={() => {                        
                            props?.navigation?.navigate('DrinkOrSmoke', {
