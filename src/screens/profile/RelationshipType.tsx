...
const RelationshipType = (props: any) => {
    ...
    useEffect(() => {
        let data;
        data = JSON.stringify(profileData?.filter(item => item?.questions_name === 'relationshipType'));
        ...
        options?.map(item => {
            data[0].options = [
                ...
                {
                    selected:
                        item === userDetails['relationshipType'] ? true : false,
                    text: item,
                },
            ];
        });
        ...
        <>
            ...
            {listData[count]?.options?.filter(item => item?.selected)?.length >
                ...
                <View
                    ...
                    <GradientBtn
                        onPress={() => {
                            props?.navigation?.navigate('TraitsAttractedTo', {
