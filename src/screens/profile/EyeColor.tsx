...
const EyeColor = (props: any) => {
    ...
    useEffect(() => {
        console.log("item?.questions_name :",profileData);
        let data;
        data = JSON.stringify(profileData?.filter(item => item?.questions_name === 'eyeColor'));
