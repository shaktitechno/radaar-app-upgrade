...
const Traits = (props: any) => {
    ...
    useEffect(() => {
        let data;
        data = JSON.stringify(profileData?.filter(item => item?.questions_name === 'traitsAttractedTo'));
        ...
        options?.map(item => {
            data[0].options = [
                ...
                {
                    selected:
                       userDetails['traitsAttractedTo']?.filter(
                            i => i === item,
                        )?.length > 0
                            ? true
                            : false,
        ...
        <>
            ...
            {listData[count]?.options?.filter(item => item?.selected)?.length >
                ...
                <View
                    ...
                    <GradientBtn
                        onPress={() => {
                            props?.navigation?.navigate('EnjoyableActivity', {
